    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <Link href="/projects" className="bg-gray-900 text-white px-8 py-3 rounded-md font-bold uppercase tracking-wider transition duration-300 hover:bg-yellow-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-500">Бүх төсөл үзэх</Link>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {projects.map((p, i) => (
            <div key={i} className="group relative overflow-hidden h-[450px] cursor-pointer transform transition-transform hover:-translate-y-1">
